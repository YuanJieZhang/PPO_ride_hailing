...
class EnvCore(object):
    ...
    def reset(self):
        """
        # When self.agent_num is set to 2 agents, the return value is a list, and each list contains observation data.txt of shape = (self.obs_dim,)
        """
        sub_agent_obs = []
    ...
    def step(self, actions):
        """
        # When self.agent_num is set to 2 agents, the input of actions is a two-dimensional list, and each list contains action data.txt of shape = (self.action_dim,).
